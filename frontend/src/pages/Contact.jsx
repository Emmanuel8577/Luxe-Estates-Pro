        ...
        <div className="container mx-auto px-6 py-20 flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="md:w-1/2 text-left">
                ...
                <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                    Have a specific property in mind or want to sell your estate? 
                    Our senior consultants are ready to assist you.
                </p>
                ...
                {!submitted ? (
                    <form onSubmit={handleSubmit} className="space-y-6 animate-in fade-in duration-500">
                        ...
                        <textarea 
                            ...
                            placeholder="Tell us what you're looking for..." rows="4" required
                            className="w-full p-4 bg-gray-50 rounded-2xl outline-none focus:ring-2 focus:ring-blue-400 transition-all"
                        ></textarea>
                    ...
                    <div className="text-center space-y-6 animate-in zoom-in duration-300">
                        ...
                        <p className="text-gray-500">
                            Thank you for reaching out. One of our luxury estate agents will contact you at <strong>{formData.email}</strong> within 24 hours.
                        </p>
                        <button 
